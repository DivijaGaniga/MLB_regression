...
ggplot(teams_hw3, aes(x=R,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=avgAtt,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=log(AB),y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=H,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=HR,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=DBLS,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=TPLS,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=BB,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=log(SO),y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=SB,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=CS,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=RA,y=100*winPct)) + geom_point()
ggplot(teams_hw3, aes(x=ER,y=100*winPct)) + geom_point()
...
x <- teams_hw3 %>%  filter(winPct < 0.6 & winPct > 0.45)

ggplot(data = x)+geom_histogram(aes(x=winPct))+scale_x_continuous()

corrmat1 <- cor(x[,1:22])
corrplot::corrplot(corrmat1,)
...
> Scatterplot between AB and Winpercent shows that AB and winning percentage are not correlated
...
>- In real world MAe can never be equal to zero and if it is model is not a perfect one.
